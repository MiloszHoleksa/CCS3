...
for q in range(D.shape[2]):
    ...
    testbounds = np.array([540, 680, 1110, 1670, 2140, 2500, 2910, 3860, 4620, 6490, 6850])#human boundary
    ...
    Resultmath[q,:]=match
    Result[q]=str(norm.sf((match[0]-match[1:].mean())/match[1:].std()))
...
plt.ylabel('STEM Course Human Correlation value',size=15)
plt.show()