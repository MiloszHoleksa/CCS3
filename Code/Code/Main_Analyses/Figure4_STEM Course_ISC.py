...
nTRs = D3.shape[1]
nSubj = D3.shape[2]
Result = np.zeros(shape=(D3.shape[2],8))
#test_ = np.array([540, 680, 1110, 1670, 2140, 2500, 2910, 3860, 4620, 6490, 6850])
#test_ = np.array([490, 630, 1060, 1620, 2090, 2450, 2860, 3810, 4570, 6440, 6800])
#test_ = np.array([590, 730, 1160, 1720, 2190, 2550, 2960, 3910, 4660, 6540, 6900])
#test_ = np.array([540, 1110, 1670, 2500, 2910, 3860, 4620, 6850])  # high
#test_ = np.array([320, 2670, 2990, 3520, 4230, 5530, 6620, 7570])  # low
test_ = np.array([680, 2140, 3450, 5070, 5380, 6490, 7360, 7430])  # mid
