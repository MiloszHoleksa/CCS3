...
for m in range(D1.shape[2]):
    ...
    human_bounds = np.array([340, 1530, 2300, 3600, 4790, 5290, 7000, 7540, 8380, 8610,
    ...
    print('Group1 Subj ' + str(m+1) + '   p value = ' + str(norm.sf((match[0]-match[1:].mean())/match[1:].std())))
nSubj2 = D2.shape[2]
...
plt.ylabel('Commercial Movie Human-model match',size=15)
plt.show()