...
for m in range(D.shape[2]):
    ...
    human_bounds = np.array([540, 1110, 1670, 2500, 2910, 3860, 4620, 6850])  # high
    human_bounds = np.array([320, 2670, 2990, 3520, 4230, 5530, 6620, 7570])  # low
    human_bounds = np.array([680, 2140, 3450, 5070, 5380, 6490, 7360, 7430])  # mid
    np.random.seed(0)
